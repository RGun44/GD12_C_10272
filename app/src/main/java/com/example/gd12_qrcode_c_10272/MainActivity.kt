package com.example.gd12_qrcode_c_10272
...
import com.example.gd12_qrcode_c_10272.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
            ...
            STORAGE_REQUEST_CODE -> {
                if (grantResults.isNotEmpty()){
                    ...
                    if (storageAccepted){
                        ...
                        showToast("Storage are requiered...")
                    }
                }
            }
        }
    ...
    private fun pickImageGallery() {
        ...
        intent.type = "image/*"
        galleryAcitivityResultLauncher.launch(intent)
    }

    private val galleryAcitivityResultLauncher = registerForActivityResult(
        ActivityResultContracts.StartActivityForResult()
    ){result ->
        if (result.resultCode == Activity.RESULT_OK){
            val data = result.data
    ...
    private fun detectResultFromImage(){
        try {
            ...
            Log.d(TAG,"detecResultFromImage: ", e)
        ...
        for (barcode in barcodes){
            ...
            when(valueType) {
                ...
                Barcode.TYPE_CONTACT_INFO -> {
                    ...
                    Log.d(TAG,"extractbarcodeQRCodeInfo: title: $title")
                    Log.d(TAG,"extractbarcodeQRCodeInfo: organisasi: $organisasi")
